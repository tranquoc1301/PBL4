        ...
        <div class="table-responsive table-bordered">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <?php endforeach; ?>
              <a href="<?= base_url('print_atd/print/') . $e_id . '/' . $data['start'] . '/' . $data['end']; ?>" target="blank" class="ml-2 d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
            </tbody>
          </table>
        </div>
      </div>
